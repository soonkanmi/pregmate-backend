...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-md sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create User</button>
    ...
    <x-jet-confirmation-modal wire:model="confirmingDelete">
        ...
        <x-slot name="content">
            {{ __('Are you sure you want to delete selected user? Once record is deleted, all of its resources and data will be permanently deleted.') }}
        </x-slot>
