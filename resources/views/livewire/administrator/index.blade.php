...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-md sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create Administrator</button>

            @if($isModalOpen)
                @include('livewire.administrator.create')
            @endif

            @if($isViewOpen)
                @include('livewire.administrator.view')
            @endif
